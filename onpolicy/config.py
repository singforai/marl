...
def get_config():
    ...
    parser.add_argument(
        "--render_mode", action="store_true", default=False, help="whether to use render mode using saved model"
    )
    # JRPO
    parser.add_argument(
        ...
        action="store_false",
        default=True,
        help="whether to use joint action loss for JRPO or TiZero",
    )
    # Tizero
    parser.add_argument(
        "--use_additional_obs",
        action="store_false",
        default=True,
        help="whether to use addtional obs for replicating the TiZero",
    )
    ...
    parser.add_argument("--notes", type=str, default="Test", help="실험에 대한 추가적인 설명을 기록합니다.")
    ...
    parser.add_argument("--n_torch_threads", type=int, default=64, help="Number of torch threads for training")
    parser.add_argument(
        "--n_rollout_threads", type=int, default=10, help="Number of parallel envs for training rollouts"
    )
    parser.add_argument(
        "--n_eval_rollout_threads", type=int, default=10, help="Number of parallel envs for evaluating rollouts"
    )
    parser.add_argument(
        "--n_render_rollout_threads", type=int, default=10, help="Number of parallel envs for rendering rollouts"
    )
    parser.add_argument(
        "--num_env_steps", type=int, default=1e11, help="Number of environment steps to train (default: 10e6)"
    )
    ...
    parser.add_argument("--critic_lr", type=float, default=2e-4, help="critic learning rate (default: 5e-4)")
    ...
    # ppo parameters
    parser.add_argument("--ppo_epoch", type=int, default=5, help="number of ppo epochs (default: 10)")
    parser.add_argument(
    ...
    parser.add_argument("--num_mini_batch", type=int, default=10, help="number of batches for ppo (default: 1)")
