...
def get_config():
    ...
    parser.add_argument("--n_torch_threads", type=int, default=10, help="Number of torch threads for training")
    parser.add_argument(
    ...
    parser.add_argument(
        "--num_env_steps", type=int, default=1e8, help="Number of environment steps to train (default: 10e6)"
    )
