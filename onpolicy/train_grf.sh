...
command="python train_grf.py --seed 0 --experiment_name tizero --group_name Tizero_real --algorithm_name tizero --use_wandb --use_linear_lr_decay --n_rollout_threads 10 --num_gpu 1"
