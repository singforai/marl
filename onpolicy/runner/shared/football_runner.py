    ...
    def run(self):
        ...
        while self.num_env_steps >= total_num_steps:
            ...
            while (step < self.episode_length) and (None in done_rollouts):
                ...
                data = step, obs, share_obs, rewards, dones, infos, values, actions, action_log_probs, rnn_states, rnn_states_critic, available_actions
...
#                interval_stack = 0
    ...
    def insert(self, data):
        step, obs, share_obs, rewards, dones, infos, values, actions, action_log_probs, rnn_states, rnn_states_critic, available_actions = data
